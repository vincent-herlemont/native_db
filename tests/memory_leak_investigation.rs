...
fn test_file_size_after_deletions() {
    ...
    println!(
        "File size after inserts: {} bytes ({:.2} MB)",
        size_after_insert,
        size_after_insert as f64 / 1024.0 / 1024.0
    );
    ...
    println!(
        "File size after deletes: {} bytes ({:.2} MB)",
        size_after_delete,
        size_after_delete as f64 / 1024.0 / 1024.0
    );
